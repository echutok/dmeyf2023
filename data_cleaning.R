...
# Loop through the columns and replace NULL and NA values with 0
...
# Set the threshold for strong correlations (e.g., 0.8)
threshold <- 0.65
...
# Remove rows with Correlation values equal to 0 and 1
