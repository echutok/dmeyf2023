...
PARAM$experimento <- "HT_compe03_caso1"
...
PARAM$trainingstrategy$semilla_azar <- 108961 # Aqui poner su  primer  semilla

PARAM$hyperparametertuning$POS_ganancia <- 273000
PARAM$hyperparametertuning$NEG_ganancia <- -7000

# Aqui poner su segunda semilla
PARAM$lgb_semilla <- 108967
#------------------------------------------------------------------------------
...
dataset <- fread("./datasets/Datasets/Competencia_03/df_cleaned_competencia03.csv.gz")
